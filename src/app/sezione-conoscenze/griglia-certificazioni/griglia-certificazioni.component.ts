...
export class GrigliaCertificazioniComponent {
  readonly infoLinkUnito: InfoLink = {
    ...
    urlImg: 'https://bosio.zip/assets/img/certificazioni/unito.webp',
    favicon: 'https://bosio.zip/assets/img/certificazioni/unito.webp',
  };

  readonly infoLinkCambridge: InfoLink = {
    ...
    urlImg: 'https://bosio.zip/assets/img/certificazioni/cambridge_bg.webp',
    favicon: 'https://bosio.zip/assets/img/certificazioni/cambridge_icon.webp',
  };

  readonly infoLinkCisco: InfoLink = {
    titolo: 'CCNA - Cisco',
    descrizione:
    ...
    urlImg: 'https://bosio.zip/assets/img/certificazioni/cisco_bg.webp',
