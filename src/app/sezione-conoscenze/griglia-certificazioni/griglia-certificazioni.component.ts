...
export class GrigliaCertificazioniComponent {
  ...
  infoLinkCambridge: InfoLink = {
    ...
    url_img:
      'https://www.cambridgeenglish.org/Images/speaking-english-lecture.jpg',
  ...
  infoLinkCisco: InfoLink = {
    ...
    url_img: 'https://bosio.zip/assets/img/certificazioni/cisco.webp',
    favicon:
      'https://translatorswithoutborders.org/wp-content/uploads/2021/12/Cisco-logo.png',
  };
}
